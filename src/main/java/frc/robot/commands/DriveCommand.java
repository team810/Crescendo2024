...
public class DriveCommand extends Command {
	...
	/**
	 * This is the buttons binding for drivetrain in telop
	 */
	...
	/**
	 * This is all the joystick binds for the drivetrain telop driving
	 */
	private void joystick()
	{
		...
		theta = MathUtil.applyDeadband(theta,.1);

		Logger.recordOutput("DriveInput/Raw/X", x);
		Logger.recordOutput("DriveInput/Raw/Y", y);
		Logger.recordOutput("DriveInput/Raw/Theta", theta);
		...
		Logger.recordOutput("DriveInput/Modified/X", x);
		Logger.recordOutput("DriveInput/Modified/Y", y);
		Logger.recordOutput("DriveInput/Modified/Theta", theta);
